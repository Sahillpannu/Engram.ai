...
export default function Hero() {
  ...
  return (
    <section ref={ref} className="relative px-6 pt-36 pb-24 sm:pt-44 lg:px-8 lg:pb-36">
      <div className="relative z-10 mx-auto grid max-w-content grid-cols-1 items-center gap-14 lg:grid-cols-2 lg:gap-16">
        {/* ---------- left ---------- */}
        <div className="relative">
          ...
          <h1 className="mt-6 text-[44px] font-normal leading-[1.04] tracking-tightest text-ink sm:text-[56px] lg:text-[72px]">
            <motion.span
              className="block"
